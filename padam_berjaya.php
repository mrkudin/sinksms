...
if ((isset($_GET['tracking'])) && ($_GET['tracking'] != "")) {
  $deleteSQL = sprintf("DELETE FROM barang WHERE no_tracking=%s",
                       GetSQLValueString($_GET['tracking'], "text"));

  mysql_select_db($database_admin_login, $admin_login);
  $Result1 = mysql_query($deleteSQL, $admin_login) or die(mysql_error());

  $deleteGoTo = "padam_berjaya_redirect.php";
